...
const Footer = () => {
  return (
    <>
      <footer className='footeri text-center text-lg-start text-muted ' style={{background:'#003060'}}>
        <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom footer'>
          <div className='me-5 d-none d-lg-block footer' style={{color:'#e8f4f9'}}>
            <span>Get connected with us on social networks:</span>
          </div>

          <div style={{color:'#e8f4f9'}}>
        ...
        <section className='footer'>
          <div className='container text-center text-md-start mt-5'style={{color:'#e8f4f9'}}>
        ...
        <div
          ...
          style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)',color:'#e8f4f9'}}
        >
          © 2023 Copyright:
